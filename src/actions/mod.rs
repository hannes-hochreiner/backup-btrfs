...
impl<C: Commands> Actions for ActionsSystem<C> {
    ...
    fn police_snapshots(
        ...
        for sv in to_be_deleted.iter().filter_map(|sv| {
            ...
            let subvolume_path =
                ActionsSystem::<C>::btrfs_to_fs_path(mount_information, &sv.btrfs_path)?;
...
mod test {
    ...
    fn btrfs_to_fs_path_1() {
        ...
        assert_eq!(
            ActionsSystem::<Commander<CommandExec>>::btrfs_to_fs_path(&mi, "/test/some/other/path")
                .unwrap(),
